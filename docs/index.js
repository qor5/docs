...
var ds=Object.defineProperty;var ps=(d,O,P)=>O in d?ds(d,O,{enumerable:!0,configurable:!0,writable:!0,value:P}):d[O]=P;var j=(d,O,P)=>(ps(d,typeof O!="symbol"?O+"":O,P),P);(function(d,O){typeof exports=="object"&&typeof module<"u"?O(require("vue")):typeof define=="function"&&define.amd?define(["vue"],O):(d=typeof globalThis<"u"?globalThis:d||self,O(d.Vue))})(this,function(d){"use strict";/*!
 * vue-global-events v3.0.1
 * (c) 2019-2023 Eduardo San Martin Morote, Damian Dulisz
 * Released under the MIT License.
 */let O;function P(){return O??(O=/msie|trident/.test(window.navigator.userAgent.toLowerCase()))}const fe=/^on(\w+?)((?:Once|Capture|Passive)*)$/,he=/[OCP]/g;function de(t){return t?P()?t.includes("Capture"):t.replace(he,",$&").toLowerCase().slice(1).split(",").reduce((r,n)=>(r[n]=!0,r),{}):void 0}const pe=d.defineComponent({name:"GlobalEvents",props:{target:{type:String,default:"document"},filter:{type:[Function,Array],default:()=>()=>!0},stop:Boolean,prevent:Boolean},setup(t,{attrs:e}){let r=Object.create(null);const n=d.ref(!0);return d.onActivated(()=>{n.value=!0}),d.onDeactivated(()=>{n.value=!1}),d.onMounted(()=>{Object.keys(e).filter(i=>i.startsWith("on")).forEach(i=>{const l=e[i],u=Array.isArray(l)?l:[l],c=i.match(fe);if(!c){__DEV__&&console.warn(`[vue-global-events] Unable to parse "${i}". If this should work, you should probably open a new issue on https://github.com/shentao/vue-global-events.`);return}let[,h,_]=c;h=h.toLowerCase();const m=u.map(g=>w=>{const M=Array.isArray(t.filter)?t.filter:[t.filter];n.value&&M.every(k=>k(w,g,h))&&(t.stop&&w.stopPropagation(),t.prevent&&w.preventDefault(),g(w))}),p=de(_);m.forEach(g=>{window[t.target].addEventListener(h,g,p)}),r[i]=[m,h,p]})}),d.onBeforeUnmount(()=>{for(const i in r){const[l,u,c]=r[i];l.forEach(h=>{window[t.target].removeEventListener(u,h,c)})}r={}}),()=>null}});var q=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};function at(t){return t&&t.__esModule&&Object.prototype.hasOwnProperty.call(t,"default")?t.default:t}function ye(t){var e=typeof t;return t!=null&&(e=="object"||e=="function")}var Q=ye,ge=typeof q=="object"&&q&&q.Object===Object&&q,me=ge,_e=me,ve=typeof self=="object"&&self&&self.Object===Object&&self,be=_e||ve||Function("return this")(),W=be,we=W,Se=function(){return we.Date.now()},$e=Se,Oe=/\s/;function Fe(t){for(var e=t.length;e--&&Oe.test(t.charAt(e)););return e}var je=Fe,Ae=je,Ce=/^\s+/;function Te(t){return t&&t.slice(0,Ae(t)+1).replace(Ce,"")}var Ie=Te,Ee=W,xe=Ee.Symbol,st=xe,wt=st,St=Object.prototype,Re=St.hasOwnProperty,Pe=St.toString,Y=wt?wt.toStringTag:void 0;function Le(t){var e=Re.call(t,Y),r=t[Y];try{t[Y]=void 0;var n=!0}catch{}var i=Pe.call(t);return n&&(e?t[Y]=r:delete t[Y]),i}var De=Le,Me=Object.prototype,ke=Me.toString;function Ne(t){return ke.call(t)}var Ue=Ne,$t=st,He=De,qe=Ue,Be="[object Null]",Ge="[object Undefined]",Ot=$t?$t.toStringTag:void 0;function ze(t){return t==null?t===void 0?Ge:Be:Ot&&Ot in Object(t)?He(t):qe(t)}var lt=ze;function Ve(t){return t!=null&&typeof t=="object"}var X=Ve,Ke=lt,Je=X,We="[object Symbol]";function Ye(t){return typeof t=="symbol"||Je(t)&&Ke(t)==We}var Ze=Ye,Qe=Ie,Ft=Q,Xe=Ze,jt=NaN,tr=/^[-+]0x[0-9a-f]+$/i,er=/^0b[01]+$/i,rr=/^0o[0-7]+$/i,nr=parseInt;function ir(t){if(typeof t=="number")return t;if(Xe(t))return jt;if(Ft(t)){var e=typeof t.valueOf=="function"?t.valueOf():t;t=Ft(e)?e+"":e}if(typeof t!="string")return t===0?t:+t;t=Qe(t);var r=er.test(t);return r||rr.test(t)?nr(t.slice(2),r?2:8):tr.test(t)?jt:+t}var or=ir,ar=Q,ct=$e,At=or,sr="Expected a function",lr=Math.max,cr=Math.min;function ur(t,e,r){var n,i,l,u,c,h,_=0,m=!1,p=!1,g=!0;if(typeof t!="function")throw new TypeError(sr);e=At(e)||0,ar(r)&&(m=!!r.leading,p="maxWait"in r,l=p?lr(At(r.maxWait)||0,e):l,g="trailing"in r?!!r.trailing:g);function w(v){var F=n,T=i;return n=i=void 0,_=v,u=t.apply(T,F),u}function M(v){return _=v,c=setTimeout(K,e),m?w(v):u}function k(v){var F=v-h,T=v-_,Z=e-F;return p?cr(Z,l-T):Z}function V(v){var F=v-h,T=v-_;return h===void 0||F>=e||F<0||p&&T>=l}function K(){var v=ct();if(V(v))return J(v);c=setTimeout(K,k(v))}function J(v){return c=void 0,g&&n?w(v):(n=i=void 0,u)}function N(){c!==void 0&&clearTimeout(c),_=0,n=h=i=c=void 0}function _t(){return c===void 0?u:J(ct())}function U(){var v=ct(),F=V(v);if(n=arguments,i=this,h=v,F){if(c===void 0)return M(h);if(p)return clearTimeout(c),c=setTimeout(K,e),w(h)}return c===void 0&&(c=setTimeout(K,e)),u}return U.cancel=N,U.flush=_t,U}var fr=ur;const Ct=at(fr),hr=d.defineComponent({__name:"go-plaid-scope",props:{init:{},formInit:{},useDebounce:{}},emits:["change-debounced"],setup(t,{emit:e}){const r=t,n=e;let i=r.init;Array.isArray(i)&&(i=Object.assign({},...i));const l=d.reactive({...i});let u=r.formInit;Array.isArray(u)&&(u=Object.assign({},...u));const c=d.reactive({...u});d.onMounted(()=>{d.nextTick(()=>{if(r.useDebounce){const m=r.useDebounce,p=Ct(g=>{n("change-debounced",g)},m);d.watch(l,(g,w)=>{p({locals:g,form:c,oldLocals:w,oldForm:c})}),d.watch(c,(g,w)=>{p({locals:l,form:g,oldLocals:l,oldForm:w})})}})});const h=d.inject("vars"),_=d.inject("plaid");return(m,p)=>d.renderSlot(m.$slots,"default",{locals:l,form:c,plaid:d.unref(_),vars:d.unref(h)})}});/*! formdata-polyfill. MIT License. Jimmy W?rting <https://jimmy.warting.se/opensource> */(function(){var t;function e(o){var a=0;return function(){return a<o.length?{done:!1,value:o[a++]}:{done:!0}}}var r=typeof Object.defineProperties=="function"?Object.defineProperty:function(o,a,s){return o==Array.prototype||o==Object.prototype||(o[a]=s.value),o};function n(o){o=[typeof globalThis=="object"&&globalThis,o,typeof window=="object"&&window,typeof self=="object"&&self,typeof q=="object"&&q];for(var a=0;a<o.length;++a){var s=o[a];if(s&&s.Math==Math)return s}throw Error("Cannot find global object")}var i=n(this);function l(o,a){if(a)t:{var s=i;o=o.split(".");for(var f=0;f<o.length-1;f++){var y=o[f];if(!(y in s))break t;s=s[y]}o=o[o.length-1],f=s[o],a=a(f),a!=f&&a!=null&&r(s,o,{configurable:!0,writable:!0,value:a})}}l("Symbol",function(o){function a(S){if(this instanceof a)throw new TypeError("Symbol is not a constructor");return new s(f+(S||"")+"_"+y++,S)}function s(S,A){this.A=S,r(this,"description",{configurable:!0,writable:!0,value:A})}if(o)return o;s.prototype.toString=function(){return this.A};var f="jscomp_symbol_"+(1e9*Math.random()>>>0)+"_",y=0;return a}),l("Symbol.iterator",function(o){if(o)return o;o=Symbol("Symbol.iterator");for(var a="Array Int8Array Uint8Array Uint8ClampedArray Int16Array Uint16Array Int32Array Uint32Array Float32Array Float64Array".split(" "),s=0;s<a.length;s++){var f=i[a[s]];typeof f=="function"&&typeof f.prototype[o]!="function"&&r(f.prototype,o,{configurable:!0,writable:!0,value:function(){return u(e(this))}})}return o});function u(o){return o={next:o},o[Symbol.iterator]=function(){return this},o}function c(o){var a=typeof Symbol<"u"&&Symbol.iterator&&o[Symbol.iterator];return a?a.call(o):{next:e(o)}}var h;if(typeof Object.setPrototypeOf=="function")h=Object.setPrototypeOf;else{var _;t:{var m={a:!0},p={};try{p.__proto__=m,_=p.a;break t}catch{}_=!1}h=_?function(o,a){if(o.__proto__=a,o.__proto__!==a)throw new TypeError(o+" is not extensible");return o}:null}var g=h;function w(){this.m=!1,this.j=null,this.v=void 0,this.h=1,this.u=this.C=0,this.l=null}function M(o){if(o.m)throw new TypeError("Generator is already running");o.m=!0}w.prototype.o=function(o){this.v=o},w.prototype.s=function(o){this.l={D:o,F:!0},this.h=this.C||this.u},w.prototype.return=function(o){this.l={return:o},this.h=this.u};function k(o,a){return o.h=3,{value:a}}function V(o){this.g=new w,this.G=o}V.prototype.o=function(o){return M(this.g),this.g.j?J(this,this.g.j.next,o,this.g.o):(this.g.o(o),N(this))};function K(o,a){M(o.g);var s=o.g.j;return s?J(o,"return"in s?s.return:function(f){return{value:f,done:!0}},a,o.g.return):(o.g.return(a),N(o))}V.prototype.s=function(o){return M(this.g),this.g.j?J(this,this.g.j.throw,o,this.g.o):(this.g.s(o),N(this))};function J(o,a,s,f){try{var y=a.call(o.g.j,s);if(!(y instanceof Object))throw new TypeError("Iterator result "+y+" is not an object");if(!y.done)return o.g.m=!1,y;var S=y.value}catch(A){return o.g.j=null,o.g.s(A),N(o)}return o.g.j=null,f.call(o.g,S),N(o)}function N(o){for(;o.g.h;)try{var a=o.G(o.g);if(a)return o.g.m=!1,{value:a.value,done:!1}}catch(s){o.g.v=void 0,o.g.s(s)}if(o.g.m=!1,o.g.l){if(a=o.g.l,o.g.l=null,a.F)throw a.D;return{value:a.return,done:!0}}return{value:void 0,done:!0}}function _t(o){this.next=function(a){return o.o(a)},this.throw=function(a){return o.s(a)},this.return=function(a){return K(o,a)},this[Symbol.iterator]=function(){return this}}function U(o,a){return a=new _t(new V(a)),g&&o.prototype&&g(a,o.prototype),a}function v(o,a){o instanceof String&&(o+="");var s=0,f=!1,y={next:function(){if(!f&&s<o.length){var S=s++;return{value:a(S,o[S]),done:!1}}return f=!0,{done:!0,value:void 0}}};return y[Symbol.iterator]=function(){return y},y}if(l("Array.prototype.entries",function(o){return o||function(){return v(this,function(a,s){return[a,s]})}}),typeof Blob<"u"&&(typeof FormData>"u"||!FormData.prototype.keys)){var F=function(o,a){for(var s=0;s<o.length;s++)a(o[s])},T=function(o){return o.replace(/\r?\n|\r/g,`\r
`)},Z=function(o,a,s){return a instanceof Blob?(s=s!==void 0?s+"":typeof a.name=="string"?a.name:"blob",(a.name!==s||Object.prototype.toString.call(a)==="[object Blob]")&&(a=new File([a],s)),[String(o),a]):[String(o),String(a)]},H=function(o,a){if(o.length<a)throw new TypeError(a+" argument required, but only "+o.length+" present.")},$=typeof globalThis=="object"?globalThis:typeof window=="object"?window:typeof self=="object"?self:this,fs=$.FormData,vt=$.XMLHttpRequest&&$.XMLHttpRequest.prototype.send,ce=$.Request&&$.fetch,ue=$.navigator&&$.navigator.sendBeacon,R=$.Element&&$.Element.prototype,x=$.Symbol&&Symbol.toStringTag;x&&(Blob.prototype[x]||(Blob.prototype[x]="Blob"),"File"in $&&!File.prototype[x]&&(File.prototype[x]="File"));try{new File([],"")}catch{$.File=function(a,s,f){return a=new Blob(a,f||{}),Object.defineProperties(a,{name:{value:s},lastModified:{value:+(f&&f.lastModified!==void 0?new Date(f.lastModified):new Date)},toString:{value:function(){return"[object File]"}}}),x&&Object.defineProperty(a,x,{value:"File"}),a}}var bt=function(o){return o.replace(/\n/g,"%0A").replace(/\r/g,"%0D").replace(/"/g,"%22")},I=function(o){this.i=[];var a=this;o&&F(o.elements,function(s){if(s.name&&!s.disabled&&s.type!=="submit"&&s.type!=="button"&&!s.matches("form fieldset[disabled] *"))if(s.type==="file"){var f=s.files&&s.files.length?s.files:[new File([],"",{type:"application/octet-stream"})];F(f,function(y){a.append(s.name,y)})}else s.type==="select-multiple"||s.type==="select-one"?F(s.options,function(y){!y.disabled&&y.selected&&a.append(s.name,y.value)}):s.type==="checkbox"||s.type==="radio"?s.checked&&a.append(s.name,s.value):(f=s.type==="textarea"?T(s.value):s.value,a.append(s.name,f))})};if(t=I.prototype,t.append=function(o,a,s){H(arguments,2),this.i.push(Z(o,a,s))},t.delete=function(o){H(arguments,1);var a=[];o=String(o),F(this.i,function(s){s[0]!==o&&a.push(s)}),this.i=a},t.entries=function o(){var a,s=this;return U(o,function(f){if(f.h==1&&(a=0),f.h!=3)return a<s.i.length?f=k(f,s.i[a]):(f.h=0,f=void 0),f;a++,f.h=2})},t.forEach=function(o,a){H(arguments,1);for(var s=c(this),f=s.next();!f.done;f=s.next()){var y=c(f.value);f=y.next().value,y=y.next().value,o.call(a,y,f,this)}},t.get=function(o){H(arguments,1);var a=this.i;o=String(o);for(var s=0;s<a.length;s++)if(a[s][0]===o)return a[s][1];return null},t.getAll=function(o){H(arguments,1);var a=[];return o=String(o),F(this.i,function(s){s[0]===o&&a.push(s[1])}),a},t.has=function(o){H(arguments,1),o=String(o);for(var a=0;a<this.i.length;a++)if(this.i[a][0]===o)return!0;return!1},t.keys=function o(){var a=this,s,f,y,S,A;return U(o,function(C){if(C.h==1&&(s=c(a),f=s.next()),C.h!=3){if(f.done){C.h=0;return}return y=f.value,S=c(y),A=S.next().value,k(C,A)}f=s.next(),C.h=2})},t.set=function(o,a,s){H(arguments,2),o=String(o);var f=[],y=Z(o,a,s),S=!0;F(this.i,function(A){A[0]===o?S&&(S=!f.push(y)):f.push(A)}),S&&f.push(y),this.i=f},t.values=function o(){var a=this,s,f,y,S,A;return U(o,function(C){if(C.h==1&&(s=c(a),f=s.next()),C.h!=3){if(f.done){C.h=0;return}return y=f.value,S=c(y),S.next(),A=S.next().value,k(C,A)}f=s.next(),C.h=2})},I.prototype._asNative=function(){for(var o=new fs,a=c(this),s=a.next();!s.done;s=a.next()){var f=c(s.value);s=f.next().value,f=f.next().value,o.append(s,f)}return o},I.prototype._blob=function(){var o="----formdata-polyfill-"+Math.random(),a=[],s="--"+o+`\r
