...
`),
	...
	utils.Demo("Presets Listing Customization Fields", examples_presets.PresetsListingCustomizationFieldsPath+"/customers", "e21_presents/listing.go"),
	Markdown(`
...
`),
	...
	utils.Demo("Presets Listing Filters", examples_presets.PresetsListingCustomizationFiltersPath+"/customers", "e21_presents/listing.go"),
	Markdown(`
...
`),
	...
	utils.Demo("Presets Listing Filter Tabs", examples_presets.PresetsListingCustomizationTabsPath+"/customers", "e21_presents/listing.go"),
	Markdown(`
...
`),
	...
	utils.Demo("Presets Listing Bulk Actions", examples_presets.PresetsListingCustomizationBulkActionsPath+"/customers", "e21_presents/listing.go"),
	Markdown(`
...
`),
	...
	utils.Demo("Search Func", examples_presets.PresetsListingCustomizationSearcherPath+"/customers", "e21_presents/listing.go"),
