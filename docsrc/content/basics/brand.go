...
`),
	...
	utils.Demo("Brand Title", presents_examples.PresetsBrandTitlePath+"/brands", "e21_presents/brand.go"),
...
`),
	...
	utils.Demo("Brand Func", presents_examples.PresetsBrandFuncPath+"/brands", "e21_presents/brand.go"),
...
`),
	...
	utils.Demo("Profile", presents_examples.PresetsProfilePath+"/brands", "e21_presents/profile.go"),
).Title("Brand").
	Slug("basics/brand")
