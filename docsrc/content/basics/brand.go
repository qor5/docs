...
`),
	...
	utils.Demo("Brand Title", presets_examples.PresetsBrandTitlePath+"/brands", "e21_presents/brand.go"),
...
`),
	...
	utils.Demo("Brand Func", presets_examples.PresetsBrandFuncPath+"/brands", "e21_presents/brand.go"),
...
`),
	...
	utils.Demo("Profile", presets_examples.PresetsProfilePath+"/brands", "e21_presents/profile.go"),
).Title("Brand").
	Slug("basics/brand")
