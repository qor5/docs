...
`),
	...
	utils.Demo("Menu Order", examples_presets.PresetsMenuOrderPath+"/books", "e21_presents/menu.go"),
	Markdown(`
## Menu group and icon
...
`),
	...
	utils.Demo("Menu Group", examples_presets.PresetsMenuGroupPath+"/videos", "e21_presents/menu.go"),
).Title("Menu").
	Slug("basics/menu")
