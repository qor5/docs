...
`),
	...
	utils.Demo("Menu Order", presets_examples.PresetsMenuOrderPath+"/books", "e21_presents/menu.go"),
	Markdown(`
## Menu group and icon
...
`),
	...
	utils.Demo("Menu Group", presets_examples.PresetsMenuGroupPath+"/videos", "e21_presents/menu.go"),
).Title("Menu").
	Slug("basics/menu")
