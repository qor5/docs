...
`),
	h.Br(),
	utils.Demo("Presets Detail Page Credit Cards", examples_presets.PresetsDetailPageCardsPath+"/customers", "examples_presets/detailing.go"),
	Markdown(`
## Menu order
...
`),
	...
	utils.Demo("Menu Order", examples_presets.PresetsMenuOrderPath+"/books", "examples_presets/menu.go"),
	Markdown(`
## Menu group and icon
...
`),
	...
	utils.Demo("Menu Group", examples_presets.PresetsMenuGroupPath+"/videos", "examples_presets/menu.go"),
).Title("Menu").
	Slug("basics/menu")
