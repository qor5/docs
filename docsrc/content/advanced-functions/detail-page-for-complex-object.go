...
`),
	...
	utils.Demo("Presets Detail Page Top Notes", presents_examples.PresetsDetailPageTopNotesPath+"/customers", "e21_presents/detailing.go"),
	Markdown(`
...
`),
	...
	utils.Demo("Presets Detail Page Details", presents_examples.PresetsDetailPageDetailsPath+"/customers", "e21_presents/detailing.go"),
	Markdown(`
