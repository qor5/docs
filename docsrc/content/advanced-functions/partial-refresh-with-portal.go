...
`),
	...
	utils.Demo("Partial Update", web_examples.PartialUpdatePagePath, "e00_basics/partial-update.go"),
	Markdown(`
...
`),
	...
	utils.Demo("Partial Reload", web_examples.PartialReloadPagePath, "e00_basics/partial-reload.go"),
	Markdown(`
