...
`),
	...
	utils.Demo("Vuetify List", vuetify_examples.HelloVuetifyListPath, "e13_vuetify_list/page.go"),
...
`),
	utils.Demo("Vuetify Menu", vuetify_examples.HelloVuetifyMenuPath, "e14_vuetify_menu/page.go"),
